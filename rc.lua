...
-- Custom theme path (assuming the path is correct)
beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/liv/theme.lua")
...
awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn("pcmanfm") end,
              {description = "OPEN YUR FILEEXPLORE", group = "Livs shit"}),

awful.key({ modkey, "Shift"   }, "f", function () awful.spawn("firefox") end,
              {description = "fox animal browser", group = "Livs shit"}),


awful.key({ modkey, "Shift"   }, "b", function () awful.spawn("qutebrowser") end,
              {description = "be a nerd in a nerd browser", group = "Livs shit"}),

awful.key({ modkey, "Shift"   }, "d", function () awful.spawn("discord") end,
              {description = "idk discord lol", group = "Livs shit"}),

awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("steam") end,
              {description = "nerd discordo", group = "Livs shit"}),

awful.key({ modkey, "Control"   }, "s", function () awful.spawn("flameshot gui") end,
              {description = "nerd discordo", group = "Livs shit"}),

awful.key({ modkey, "Control"   }, "h", function () awful.spawn("heroic") end,
              {description = "nerd discordo", group = "Livs shit"}),
...
-- Set keepassxc to always map on the tag named "2" on screen 1.
...
--startup noises (diesnt work ssooooo)
